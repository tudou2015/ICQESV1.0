...
image1 = im2single(imread(image_in));
image2 = im2single(imread(image_out2));
...
image_out1=[filename,'.png'];
image_out2=[filename,'_png.bmp'];
str_out1= ['ffmpeg -i ',image_in,' ',image_out1];
str_out2= ['ffmpeg -i ',image_out1,' ',image_out2];
system(str_out1);   
system(str_out2);  
...
image_out2=[filename,'_jpeg.bmp'];
str_out1= ['ffmpeg -i ',image_in,' ',image_out1];
str_out2= ['ffmpeg -i ',image_png,' ',image_out2];
system(str_out1);   
system(str_out2);  
